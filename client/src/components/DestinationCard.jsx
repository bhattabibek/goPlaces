    ...
    <>
      <div className="flex flex-col w-full gap-6 m-3 justify-center md:flex md:flex-row">
        <div className="relative shadow-lg overflow-hidden ">
          <img
            className=" transition-transform duration-300 hover:scale-105 inset-0 object-cover"
            src="/nepal.jpg"
          />
          <h2 className="text-center font-bold">Chitwan National Park</h2>
          <p className="p-6">
            animi doloremque voluptates nemo, cum delectus consectetur beatae
            consequatur error aliquam, repellat nesciunt nulla nam. Aliquam,
            odio qui quo sed commodi accusamus cum nam consequuntur illum
            incidunt vero quis eligendi?
          </p>
