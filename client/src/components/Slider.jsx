  ...
  return (
    <div className="slider-container h-6 bg-opacity-5 relative0">
      <Slider {...settings} className="relative">
        <div>
          <img
            className="w-full h-[80vh] relative object-cover"
            src="/image.jpg"
            alt="Mountain"
          />
      ...
      <div className="flex flex-row">
        <div className="absolute inset-0 text-white text-2xl font-bold flex items-center">
          ...
          <br /> attractive Destinations <br />
          in Nepal for you next Holidays.
          <br />
          <button className="border border-white rounded-3xl p-4">
            Explore Now
          </button>
        </div>
      </div>
